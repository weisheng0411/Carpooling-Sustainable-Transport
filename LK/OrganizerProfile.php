...
<div class="container">
    <h2>Event Organizer Profile</h2><hr><br>
    ...
    <form class="form-grid">
       <input type="hidden" name="id" value='<?php echo $row['user_id']?>'>
        ...
        <div class="form-group full">
            ...
            <textarea rows="5" name='details' readonly><?php echo $row['Description']?></textarea>
        </div>

        <div class="btn-row full">
        <button class="edit" type="button" onclick="window.location.href='EditOrgaProfile.php'">Edit</button>
